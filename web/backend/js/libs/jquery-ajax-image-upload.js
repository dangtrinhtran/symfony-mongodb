...
jQuery(document).ready(function($) {
    ...
    window.JQUERY4U.AJAXIMAGEUPLOAD = {
        ...
        {
            var _this = this;
			//if ($('#post_featuredimage').length > 0 ) {
            //capture image upload
			var $post = $('#post_featuredimage');
			$post.live('change', function(e)
            //$('#post_featuredimage').live('change', function(e)
            {
                e.preventDefault();
        ...
        {
            this.cache.$imgPreview.attr('src','backend/images/index.jpg');
            this.cache.$imgOriginal.attr('src','');
            $('.img-data').remove();
            $('#post_featuredimage').val('');
